# Experiment 2: Binary Classification WebApp with Streamlit
...
```bash
https://github.com/Elfinxd/Binary-Classification-WebApp.git
...
Now, the app will be available at https://binary-classification-webapp-wjanxbrrwr82cvcnrpklhd.streamlit.app.

### Step 4: Interact with the App

Open your browser and go to https://binary-classification-webapp-wjanxbrrwr82cvcnrpklhd.streamlit.app.
...
![image](https://github.com/user-attachments/assets/7c853369-3138-475c-bef8-34beba37c576)
